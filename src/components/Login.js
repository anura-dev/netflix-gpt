    ...
    <div>
      <Header />
        ...
        <form className='absolute w-3/12 p-12 bg-black my-36 mx-auto right-0 left-0 text-white bg-opacity-80' >
           ...
           {!isSignInForm && (<input type='text' placeholder='Full Name' className='p-3 my-4 w-full rounded-lg bg-gray-700'/>)}
            <input type='text' placeholder='Email Address' className='p-3 my-4 w-full rounded-lg bg-gray-700'/>
